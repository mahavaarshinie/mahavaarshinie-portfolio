...
export const PROJECTS = [
  { title: "Deepfake Detection Framework", desc: "Achieved 98.05% accuracy using Dual-Stream Hybrid CNN with RNN, LSTM, and Transformers.", tags: ["Computer Vision", "AI", "98.05% Accuracy"], image: "https://images.unsplash.com/photo-1633412802994-5c058f151b66?q=80&w=1000" },
  { title: "SmartStock AI", desc: "Decision support system for SME inventory optimization using AI-driven demand forecasting.", tags: ["FastAPI", "React.js", "Forecasting"], image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1000" },
  { title: "The Inclusive Citizen", desc: "Multilingual NLP app for ASEAN dialects using the SEA-LION dataset and FastAPI.", tags: ["NLP", "SEA-LION", "FastAPI"], image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=1000" },
  { title: "Online Tutor Booking System", desc: "Flask and SQLAlchemy prototype featuring real-time filtering and automated scheduling.", tags: ["Flask", "SQLAlchemy", "Python"], image: "https://images.unsplash.com/photo-1509062522246-3755977927d7?q=80&w=1000" }
];
